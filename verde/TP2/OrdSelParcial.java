...
public class OrdSelParcial {
    ...
    public class Jogador {
        ...
        public static void ordenarPorNome(List<Jogador> jogadores, int k) {
            // k = 10;
            // codigo de ordenação
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            Jogador jogador = new OrdSelParcial().new Jogador(); // croa um jogador
            jogador.ler(novoId); // le o jogador
            jogadores.add(jogador); // adiciona o jogador a lista jogadores
        }
        // ordena por seleção
        Jogador.ordenarPorNome(jogadores, 10);
